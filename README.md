...
- **نسخة الاستقرار السابقة:** `stable/route-drawing-baseline`
- **نسخة الاستقرار الحالية المختبرة:** `stable/vehicle-session-route-persistence-v1`
- **آخر commit موثق للحالة الحالية:** `054a8feaf58e6b41400dbde4a55da3bfe853e625`
