...
class RoutePlanService {
  ...
  Future<List<PlannedRoute>> listApprovedRoutes({int limit = 80}) async {
  ...
  @Deprecated('استخدم getLineDirection')
  ...
  Future<void> requestEdit({
    ...
    final r = reason.trim();
    if (r.isEmpty) throw ArgumentError('يجب كتابة سبب طلب التعديل');
