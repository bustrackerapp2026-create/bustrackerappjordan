...
class _ProfileTabState extends State<ProfileTab> {
  ...
  Future<void> _setShareLocation(bool value) async {
    ...
    // مزامنة اختيارية مع Firestore ليظهر الراكب للأدمن عند المشاركة
  ...
  Future<void> _editProfile() async {
    ...
    try {
      ...
      if (mounted) _snack('✅ تم تحديث الملف الشخصي');
    } catch (e) {
  ...
  Widget build(BuildContext context) {
    ...
    final phone = user?.displayPhone ?? 'غير محدد';
              ...
              child: Column(
                children: [
                  ...
                  _tile(
                    ...
                    subtitle: 'قريباً',
                    onTap: () => _snack('🔜 سيتم تفعيل تغيير كلمة المرور قريباً'),
                  ),
                ],
              ),
            ),
              ...
              child: Column(
                children: [
                  _tile(
                    ...
                    onTap: () {
                      // الانتقال لتبويب الرحلات عبر البحث عن الـ Dashboard الأب صعب؛
                      // نوجّه المستخدم عبر رسالة واضحة.
              ...
              child: Column(
                children: [
                  ...
                  _tile(
                    ...
                    onTap: () => _snack('📱 Bus Tracker Jordan — 1.0.0+1'),
                  ),
                  _divider(),
                  _tile(
