    ...
    return Stack(
      children: [
          ...
          child: RepaintBoundary(
            child: _DriverMapFabColumn(
              ...
              onAddPickup: () {
                ...
                MapUtils.showSnackBar(
                  context,
                  isAddingPickupPoint ? l10n.tapMapToAddPoint : l10n.cancelled,
        ...
        Positioned(
          ...
          child: RepaintBoundary(
            child:
                Selector<DriverProvider, ({bool isOnline, bool isTripActive})>(
              selector: (_, p) =>
                ...
                child: SizedBox(
                  ...
                  child: ElevatedButton.icon(
                    ...
                    style: ElevatedButton.styleFrom(
                      ...
                      foregroundColor: isOnline ? Colors.black87 : Colors.white,
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(14),
                      ),
                    ),
